...
class SpecimenDwJob {
    static triggers = {
//         cron name: 'SpecimenDwTrigger', cronExpression: "0 18 15 * * ?" 
         cron name: 'SpecimenDwTrigger', cronExpression: "0 0 22 * * ?" 
    } 
        ...
        if (isRunning) {
            if(isRunning.value.equals('NOTRUNNING')) {
                try {
                    ...
                    def fixUp = AppSetting.findByCode('SPECIMEN_DW_RUN_STATUS')
