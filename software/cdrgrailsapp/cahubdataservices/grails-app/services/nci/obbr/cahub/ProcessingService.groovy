                    ...
                    def specimenRecord = SpecimenRecord.findBySpecimenId(it.'@id'.text())
                        if(specimenRecord) {
                            def aliquotSpecimen
                                ...
                                derivativeId: it.derivatives.specimen.'@id'.text(),
                                containerType: ContainerType.findByCode(it.derivatives.specimen.container.'@code'.text().toUpperCase()),
                                fixative: Fixative.findByCode(it.derivatives.specimen.fixative.'@code'.text().toUpperCase()),
