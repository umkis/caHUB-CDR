    ...
    <body>
      ...
      <div id="container" class="clearfix">
            ...
            <div class="list">
                ...
                <div class="clearfix tablefooter"><div class="left">Most recently created on top</div><div class="right"><a href="/cahubdataservices/interviewRecord/list">View all Interviews >></a></td></div><br /><div class="left querytracker">QT = Number of active queries</div></div>
