            ...
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: queryInstance, field: 'gtexCrf', 'errors')}">
                    <div>
                        ...
                        <span class="bpvFormCheckBox ${queryInstance?.caseRecord?.study?.code == 'BPV' && showFormList ? '' : 'hide'}"><g:checkBox name="bpvLocalPath" value="${queryInstance?.bpvLocalPath}" />&nbsp;<label for="bpvLocalPath">BPV Local Pathology Review Form</label></span>
                    </div>
                </td>
            </tr>
