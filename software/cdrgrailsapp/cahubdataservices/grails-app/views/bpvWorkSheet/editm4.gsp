        ...
        <div class="dialog line">
           ...
           <tbody>
                  ...
                  <tr class="prop">
                    <td valign="top" class="name">
                     ...
                     <tr class="prop">
                    <td valign="top" class="name">
                     <label for="fixativeTimeInRange">Were the Priority III FFPE specimens processed with <1 hour delay to fixation and  23 hour time in fixative?</label>
                       </td>
          ...
          <br></br>
              ...
              <table>
                ...
                <tr class="odd">
                <td>FFPE tissue 1</td>  
                <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeId1', 'errors')}">
                 ...
                 <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeWeight1', 'errors')}">
                  ...
                  <tr class="even">
                <td>FFPE tissue 2</td>  
                <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeId2', 'errors')}">
                 ...
                 <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeWeight2', 'errors')}">
                  ...
                  <tr class="odd">
                <td>FFPE tissue 3</td>  
                <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeId3', 'errors')}">
                 ...
                 <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFfpeWeight3', 'errors')}">
                  ...
                  <tr class="even">
                   ...
                   <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFrozenId1', 'errors')}">
                   ...
                   <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFrozenId2', 'errors')}">
                   ...
                   <td valign="top" class="value ${hasErrors(bean: module4SheetInstance, field: 'ttFrozenId3', 'errors')}">
