...
<table border="0">
  ...
  <tr class="odd">
    <td>FFPE tissue 1</td>  
    <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFfpeId1', 'errors')}">
...
<tr class="even">
  <td>FFPE tissue 2</td>  
  <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFfpeId2', 'errors')}">
...
<tr class="odd">
  <td>FFPE tissue 3</td>  
  <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFfpeId3', 'errors')}">
...
<tr class="even">
  ...
  <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFrozenId1', 'errors')}">
...
<tr class="odd">
  ...
  <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFrozenId2', 'errors')}">
...
<tr class="even">
  ...
  <td valign="top" class="value ${hasErrors(bean: module3SheetInstance, field: 'ntFrozenId3', 'errors')}">
