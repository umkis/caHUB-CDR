         ...
         <table class="bpvws">
          <tbody>
            ...
            <tr class="prop" >
              ...
              <td class="${errorMap.get("sampleId4Frozen_" +module4NSheetInstance?.sampleFr?.id)}"><g:textField class="recorddate" name="sampleId4Frozen_${module4NSheetInstance?.sampleFr?.id}" value="${module4NSheetInstance?.sampleFr?.sampleId4Frozen}" /></td>
          </tr>
          <tr class="prop">
