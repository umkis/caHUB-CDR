      ...
      <div class="line">
          ...
          <tbody>
            ...
            <tr class="prop" >
              ...
              <td class="${errorMap.get("sampleId4Frozen_" +module2SheetInstance?.sampleFr?.id)}"><g:textField class="recorddate" name="sampleId4Frozen_${module2SheetInstance?.sampleFr?.id}" value="${module2SheetInstance?.sampleFr?.sampleId4Frozen}" /></td>
          </tr>
          <tr class="prop">
      ...
      <table class="bpvws">
        ...
        <g:each in="[module2SheetInstance.sampleQc, module2SheetInstance.sampleE, module2SheetInstance.sampleF, module2SheetInstance.sampleG, module2SheetInstance.sampleH]" status="i" var="s">
          ...
          <tr id="${s.protocolId}">
            ...
            <td class="${errorMap.get("sampleId4Record_" +s.id)}"><g:textField class="recorddate" name="sampleId4Record_${s.id}" value="${s.sampleId4Record}" size="18" /></td>
