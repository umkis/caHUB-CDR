           ...
           <g:form controller="userLogin" action="list">
             <table style="border: 0px">
               <tr> 
                ...
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;End: <g:jqDateTimePicker name="end" value="${end}" />
            ...
            <p>
              ...
              <g:if test="${userName}"> for <b>${userName}</b>
              </g:if>
              <g:elseif test="${organization}"> for <b>${organization}</b>
              </g:elseif>
            </p>
            <br/>
                ...
                <table>
                    <thead>
                        <tr>
                             ...
                             <g:sortableColumn property="username" title="${message(code: 'userLogin.username.label', default: 'Username')}" />
                              <g:sortableColumn property="organization" title="Organization" />
                                <g:sortableColumn property="loginDate" title="${message(code: 'userLogin.loginDate.label', default: 'Login Date')}" />
                              <g:sortableColumn property="sessionDestroyed" title="${message(code: 'userLogin.sessionDestroyed.label', default: 'Session Destroyed')}" />
                               <g:sortableColumn property="logout" title="${message(code: 'userLogin.logout.label', default: 'Logout')}" />
                        
                          
                        
                            <g:sortableColumn property="sessionCreated" title="${message(code: 'userLogin.sessionCreated.label', default: 'Session Created')}" />
                        
                            <g:sortableColumn property="sessionLastAccessed" title="${message(code: 'userLogin.sessionLastAccessed.label', default: 'Session Last Accessed')}" />
                             <g:sortableColumn property="sessionId" title="${message(code: 'userLogin.sessionId.label', default: 'Session Id')}" />
