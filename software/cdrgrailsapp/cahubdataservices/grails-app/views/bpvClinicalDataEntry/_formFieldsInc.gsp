...
<%--                <tr class="prop">                
          ...
          <g:if test="${bpvClinicalDataEntryInstance.caseRecord.primaryTissueType.toString() == 'Ovary'}">
              ...
              <tr class="prop">
                  ...
                  <td valign="top" class="value ${hasErrors(bean: bpvClinicalDataEntryInstance, field: 'clinicalFIGOStg', 'errors')}">
                      <g:select name="clinicalFIGOStg" from="${['Stage IA','Stage IA1','Stage IA2','Stage IB','Stage IB1','Stage IB2','Stage IIA','Stage IIA1','Stage IIA2', 'Stage IIB','Stage IIC','Stage IIIA','Stage IIIB','Stage IIIC','Stage IVA','Stage IVB','Not Available']}" value="${bpvClinicalDataEntryInstance?.clinicalFIGOStg}" noSelection="['': '']" />
                  </td>
              </tr>
          </g:if>
          <g:else>
          ...
          <tr class="prop clearborder">
              <td colspan="2" class="name ${hasErrors(bean: bpvClinicalDataEntryInstance, field: 'perfStatusScale', 'errors')}">
                ...
                <div class="subentry value perfStatusScale">
                  <g:radio name="perfStatusScale" id="karnofsky" value="Karnofsky Score" checked="${bpvClinicalDataEntryInstance?.perfStatusScale == 'Karnofsky Score'}" />&nbsp;<label for="karnofsky">Karnofsky Score</label><br>
                  <g:radio name="perfStatusScale" id="ecog" value="Eastern Cancer Oncology Group" checked="${bpvClinicalDataEntryInstance?.perfStatusScale == 'Eastern Cancer Oncology Group'}" />&nbsp;<label for="ecog">Eastern Cancer Oncology Group</label><br>
                  <g:radio name="perfStatusScale" id="notRecorded" value="Not Recorded" checked="${bpvClinicalDataEntryInstance?.perfStatusScale == 'Not Recorded'}" />&nbsp;<label for="notRecorded">Not recorded</label><br>
                </div>   
              </td>
          </tr>
          ...
          <tr class="prop clearborder">
            ...
            <tr class="subentry prop" id="timingOfScoreOsRow" style="display:${bpvClinicalDataEntryInstance?.timingOfScore == 'Other, Specify'?'display':'none'}">
                  <td colspan="2" class="value ${hasErrors(bean: bpvClinicalDataEntryInstance, field: 'timingOfScoreOs', 'errors')}">
                      <g:textField name="timingOfScoreOs" maxlength="255" value="${bpvClinicalDataEntryInstance?.timingOfScoreOs}" />
                  </td>
              </tr>               
