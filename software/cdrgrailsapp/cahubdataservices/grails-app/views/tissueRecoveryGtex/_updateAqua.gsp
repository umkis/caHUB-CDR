          ...
          <g:each in="${specimensTRF}" var="a" status="i">
            <g:if test="${!(a.gtexSequenceNum() in['0011','0014','0001','0002','0003','0004','0005','0006','0008', '0007', '0009', '0010']) && a.fixative.code != 'DICE'}">
              <tr class="${(i % 2) == 0 ? 'odd' : 'even'} aqua-row" id="aqua-${aquaCnt++}">
                ...
                <td>${a.fixative}</td>
                <td class="td_aliquotTimeRemoved">
                  ...
                  <br><a class="uibutton removepadding borderless ca-tooltip-nobg" data-msg="If Time Removed exceeded 20 minutes before last collection, please explain in comments." ><span class="ui-icon ui-icon-info"></span></a>
                </td>
                <td class="td_aliquotTimeFixed">
                  ...
                  <br><a class="uibutton removepadding borderless ca-tooltip-nobg" data-msg="If Time Put in Fixative exceeded 20 minutes after Time Removed, please explain in comments." ><span class="ui-icon ui-icon-info"></span></a>
                </td>                                                                                   
                <td class="td_aliquotTimeStabilized">
                  ...
                  <br><a class="uibutton removepadding borderless ca-tooltip-nobg" data-msg="If Time Placed in Stabilizer was under 6 hours after Time Put in Fixative, please explain in comments." ><span class="ui-icon ui-icon-info"></span></a>
                </td>                                      
