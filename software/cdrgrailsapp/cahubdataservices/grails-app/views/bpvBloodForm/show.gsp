...
<g:set var="bodyclass" value="bpvbloodform show bpv-study" scope="request"/>
<html>
    <head>
        ...
        <script type="text/javascript" src="${resource(dir:'js/bpv',file:'bloodform.js')}?bv<g:meta name='app.version'/>-${ts ?: ''}"></script>   
    </head>
    <body>
