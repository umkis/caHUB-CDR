                          ...
                          <g:if test="${specimen.tissueType.code == 'BLOODPLAS' || specimen.tissueType.code == 'BLOODSRM' || specimen.tissueType.code == 'BLOODRNA' || specimen.tissueType.code == 'BLOODDNA'}">
                            <g:if test="${specimen.containerType.code == 'SST' || specimen.containerType.code == 'LAVEDTA' || specimen.containerType.code == 'RNAPAX' || specimen.containerType.code == 'DNAPAX'}">
                              ...
                              <tr id="gen1row${i}" class="gen1 gen1-<%=  gen1Type.toLowerCase() %> ${specimen.bloodTimeDraw}-draw">
                                    ...
                                    <td class="specimenIdName">${specimen.specimenId}</td>
                                    ...
                                    <td class="editOnly textcenter">
                                      ...
                                      <g:remoteLink class="deleteOnly button ui-button  ui-state-default ui-corner-all removepadding" title="Delete" action="deleteSpecimen" value="Delete" update='[success:"ParentTubes"]' params="'tube=Parent'" before="if(!validateSpecDelete('gen1row${i}','${gen1Type}')) return false" onSuccess="deleteParentSpecimens('gen1row${i}',${bpvBloodFormInstance.caseRecord.id}, '${gen1Type}')" id="${specimen.id}" ><span id="imgDel_${specimen.id}" class="ui-icon ui-icon-trash">Delete</span></g:remoteLink>
                                    </td>
                              </tr>
                           <%  def gen2Type = ""%>
                              ...
                              <g:each in="${slist.sort{it.specimenId}}" status="j" var="u">
                                ...
                                <g:elseif test="${u.tissueType.code == 'BLOODDNA'}"><%  gen2Type = "DNA" %></g:elseif>
                                 <g:if test="${!u.parentSpecimen.parentSpecimen}">
                                    <tr class="gen2 gen1row${i} gen2-<%=  gen2Type?.toLowerCase() %>-parent" id="gen2-${u.id}-parent">
                                        <td></td><td class="ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-e"></span>${u.specimenId}</td>
                                        ...
                                        <td class="editOnly textcenter">
                                            <g:if test="${u.tissueType.code == 'BLOODSRM'}">
                                                  ...
                                                  <g:remoteLink class="deleteOnly button ui-button  ui-state-default ui-corner-all removepadding" title="Delete"  action="deleteSpecimen" value="Delete" update="SerumTubes"  params="'tube=Serum'" id="${u.id}" onComplete="uiDelAliquot('${u.id}',2)" ><span class="ui-icon ui-icon-trash">Delete</span></g:remoteLink>
                                            </g:if>
                          ...
                          <%  def gen3Type = ""%>
                           <g:set var="ulist" value="${SpecimenRecord.findAllByParentSpecimen(u)}" />
                              <g:each in="${ulist.sort{it.specimenId}}" status="k" var="v">
                                ...
                                <tr class="gen3 gen1row${i} gen3-<%=  gen3Type?.toLowerCase() %>-parent" id="gen3-${v.id}-parent">
                                    <td></td><td class="ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-e"></span>${v.specimenId}</td>
                                    ...
                                    <td class="editOnly textcenter">
                                            <g:if test="${v.tissueType.code == 'BLOODSRM'}">
                                                  ...
                                                  <g:remoteLink class="deleteOnly button ui-button  ui-state-default ui-corner-all removepadding" title="Delete"  action="deleteSpecimen" value="Delete" update="SerumTubes"  params="'tube=Serum'" id="${v.id}" onComplete="uiDelAliquot('${v.id}',3)" ><span class="ui-icon ui-icon-trash">Delete</span></g:remoteLink>
                                            </g:if>
                                          <g:elseif test="${v.tissueType.code == 'BLOODPLAS'}">
                                                 <a title="Edit" href="" onClick="editPlasma('${v.id}','${v.specimenId.replace("'","\\'")}','${v.chpBloodRecord?.volume}');return false;" class="editOnly button ui-button  ui-state-default ui-corner-all removepadding"><span class="ui-icon ui-icon-pencil">Edit</span></a>
                                                  <g:remoteLink class="deleteOnly button ui-button  ui-state-default ui-corner-all removepadding" title="Delete"  action="deleteSpecimen" value="Delete" update="PlasmaTubes"  params="'tube=Plasma'" id="${v.id}" onComplete="uiDelAliquot('${v.id}',3)" ><span class="ui-icon ui-icon-trash">Delete</span></g:remoteLink>
                                          </g:elseif>
                                    </td>
                                </tr>
                              </g:each>
