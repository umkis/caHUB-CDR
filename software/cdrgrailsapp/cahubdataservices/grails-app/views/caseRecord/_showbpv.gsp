            ...
            <g:if test="${!s.parentSpecimen}">
              ...
              <g:each in="${slist}" status="j" var="u">
                <g:if test="${!u.parentSpecimen.parentSpecimen}">
                  <tr class="${(parity++ % 2) == 0 ? 'odd' : 'even'}">
                    <td></td>
                    <td class="itemid"><g:link action="show" controller="specimenRecord" id="${u.id}">${u.specimenId}</g:link></td>
                  <td></td>
                  <td>${u.tissueType}</td>
                  ...
                  <g:each in="${ulist}" status="k" var="v">
                    <tr class="${(parity++ % 2) == 0 ? 'odd' : 'even'}">
                      <td></td>
                      <td></td>
                      <td class="itemid"><g:link action="show" controller="specimenRecord" id="${v.id}">${v.specimenId}</g:link></td>
                    <td>${v.tissueType}</td>
