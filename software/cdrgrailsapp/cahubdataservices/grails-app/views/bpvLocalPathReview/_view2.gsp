                                    ...
                                    <tr class="prop clearborder">
                                        <td class="name" >
                                            ...
                                            <g:else>
                                                14. This slide meets the microscopic analysis criteria of the BPV project of necrosis percentage of <20% and tumor content of &ge;50% tumor cells by surface area:
                                            </g:else>
                                    ...
                                    <tr class="prop">
                                        <td class="name" colspan="2">
                                            ...
                                            <g:else>
                                                15. Pathology review comments:<br />
                                            </g:else>
                                    ...
                                    <tr class="prop clearborder">
                                        <td class="name" >
                                            ...
                                            <g:else>
                                                16. This slide is consistent with the findings of the Diagnostic Pathology Report for this case:
                                            </g:else>
                                    ...
                                    <tr class="prop">
                                        <td class="name" >
                                            ...
                                            <g:else>
                                                17. Name of local BSS reviewing pathologist:
                                            </g:else>
                                    ...
                                    <tr class="prop">
                                        <td class="name" >
                                            ...
                                            <g:else>
                                                18. Date of Slide review by the pathologist:
                                            </g:else>
                                        </td>
                                    ...
                                    <tr class="prop">
                                        <td class="name" >
                                            ...
                                            <g:else>
                                                19. Data entry in the Local Pathology Review form was performed by:
                                            </g:else>
                                        </td>
                                        <td class="value" > 
