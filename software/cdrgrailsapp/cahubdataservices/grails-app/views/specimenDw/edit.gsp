                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="caseRecord"><g:message code="specimenDw.caseRecord.label" default="Case Record" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: specimenDwInstance, field: 'caseRecord', 'errors')}">
                                    <g:select name="caseRecord.id" from="${nci.obbr.cahub.datarecords.CaseRecord.list()}" optionKey="id" value="${specimenDwInstance?.caseRecord?.id}"  />
                                </td>
                            </tr>
