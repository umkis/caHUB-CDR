            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="specimenDw.caseRecord.label" default="Case Record" /></td>
                            
                            <td valign="top" class="value"><g:link controller="caseRecord" action="show" id="${specimenDwInstance?.caseRecord?.id}">${specimenDwInstance?.caseRecord?.encodeAsHTML()}</g:link></td>
