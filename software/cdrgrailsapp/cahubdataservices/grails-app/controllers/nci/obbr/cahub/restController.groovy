                ...
                try
                {
                    ...
                    if (event.size() > 0) {
                        if (event.size() > 1) {
                            ...
                            event.each {
                                payload = payload + "<li><span><a href=\"/cahubdataservices/rest/getcbrapievent/"+ it.bio4dEventId + "/" + +it.id + "\">" + it.eventType + "</a></span></li>" + "<br>"
                            }
                            payload = payload + "</ul>"
                        } else {
            ...
            else
            {
                ...
                { 
                    while(value)
                    {
                        ...
                        {
                            def caseRecord = CaseRecord.findByCaseId(key.replace('*', '' + n))
