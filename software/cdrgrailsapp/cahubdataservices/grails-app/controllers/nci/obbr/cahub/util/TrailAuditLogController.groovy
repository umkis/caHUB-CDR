        ...
        while (true)
        {
            ...
            if (index > 0)
            {
                ...
                if (index > 0)
                {
                    ...
                    objectId = action.substring(index + 1)
                    action = action2
                }
            ...
            if ((!tempList)||(tempList.size() == 0)) println 'null out put classNameFull='+classNameFull+',  objectId=' + objectId
//            else 
//            {
//                tempList.each()
//                    {
...
//            }
        ...
        [auditLogEventInstanceList: auditLogEventInstanceList, errorMessage:errorMessage, childForms:childForms, auditLogEventInstanceTotal: auditLogEventInstanceTotal, className: className, objectId: objectId, goBackUrl: '/' + className + '/' + action + '/' + objectId ]
    }
...
//            foundFullClassNames.each() { key, value ->
