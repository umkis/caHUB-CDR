...
//            }            
        ...
        if (bpvClinicalDataEntryInstance.bloodRelCancer1 != null && bpvClinicalDataEntryInstance.relCancerType1 == null) {
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType1', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer1)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer2 != null && bpvClinicalDataEntryInstance.relCancerType2 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType2', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer2)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer3 != null && bpvClinicalDataEntryInstance.relCancerType3 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType3', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer3)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer4 != null && bpvClinicalDataEntryInstance.relCancerType4 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType4', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer4)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer5 != null && bpvClinicalDataEntryInstance.relCancerType5 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType5', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer5)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer6 != null && bpvClinicalDataEntryInstance.relCancerType6 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType6', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer6)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer7 != null && bpvClinicalDataEntryInstance.relCancerType7 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType7', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer7)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer8 != null && bpvClinicalDataEntryInstance.relCancerType8 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType8', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer8)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer9 != null && bpvClinicalDataEntryInstance.relCancerType9 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType9', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer9)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer10 != null && bpvClinicalDataEntryInstance.relCancerType10 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType10', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer10)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer11 != null && bpvClinicalDataEntryInstance.relCancerType11 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType11', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer11)
        } 
        if (bpvClinicalDataEntryInstance.bloodRelCancer12 != null && bpvClinicalDataEntryInstance.relCancerType12 == null) { 
            bpvClinicalDataEntryInstance.errors.rejectValue('relCancerType12', 'Please enter the type of cancer for the specified relative - '+bpvClinicalDataEntryInstance.bloodRelCancer12)
        } 
...
//            }            
        ...
        if (bpvClinicalDataEntryInstance.timingOfScore.equals(null)) {
            bpvClinicalDataEntryInstance.errors.rejectValue('timingOfScore', 'Timing of score is a required field')
        } else if (bpvClinicalDataEntryInstance.timingOfScore.equals('Other, Specify') && bpvClinicalDataEntryInstance.timingOfScoreOs.equals(null)) {
