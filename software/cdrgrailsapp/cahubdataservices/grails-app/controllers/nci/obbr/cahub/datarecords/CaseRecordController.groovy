...
class CaseRecordController {
	...
	def study = session.study
        ...
        def frozenList = caseRecordService.getFrozenList(caseList)

        def brainList = caseRecordService.getBrainList(caseList)

        return [caseRecordInstanceList: caseList, caseRecordInstanceTotal: count, specimenCount:specimenCount, specimenCountBMS:specimenCount, queryCount:queryCount, frozenList:frozenList, brainList:brainList,sixMonthFollowUpStat:sixMonthFollowUpStat]
    }
    ...
    def show = {   
        ...
        [caseRecordInstance:caseRecordInstance, altMap:altMap, hasBrain:hasBrain, specimenCount:specimenCount, queryCount:queryCount, deviationCount:deviationCount, qtAttachments:qtAttachments,ctc_patient_visits:ctc_patient_visits, username:username,brainList:brainList,frozenList:frozenList]
    ...
    def view = {
        ...
        [caseRecordInstance:caseRecordInstance, altMap:altMap, queryCount:queryCount, deviationCount:deviationCount, qtAttachments:qtAttachments,brainList:brainList,frozenList:frozenList]
        ...
        if (caseRecordInstance) {
            ...
            if (params.version) {
                ...
                if (caseRecordInstance.version > version) {
                    ...
                    caseRecordInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'caseRecord.label', default: 'Case Record For Case')] as Object[], "Another user has updated this CaseRecord while you were editing")
