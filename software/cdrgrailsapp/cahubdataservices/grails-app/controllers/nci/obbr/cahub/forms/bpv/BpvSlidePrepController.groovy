...
//            }
    ...
    def addSlide2 = {
       ...
       // println("here/////")
        render(view: "slideTable2", model: [slideRecord: slideRecord, slides:SlideRecord.findAllByCaseId(caseId,[sort: "slideId"])])
    }
    ...
    def deleteSlide2 = {
        ...
        render(view: "slideTable2", model: [slideRecord:slideRecord, slides:SlideRecord.findAllByCaseId(params.caseId,[sort: "slideId"])])
    }
    def update = {
        def bpvSlidePrepInstance = BpvSlidePrep.get(params.id)
        if(bpvSlidePrepInstance) {
