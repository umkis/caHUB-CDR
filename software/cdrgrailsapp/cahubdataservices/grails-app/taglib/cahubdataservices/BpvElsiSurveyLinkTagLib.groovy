...
class BpvElsiSurveyLinkTagLib {
    ...
    def bpvelsisurveylink = { attrs, body ->
        ...
        def sr = attrs.sr
            ...
            if(!sr.dateSubmitted && !sr.answers && session.DM == true && session.org.code == sr.interviewRecord.orgCode){
            ...
            else if(!sr.dateSubmitted && sr.answers && session.DM == true && (session.org.code == sr.interviewRecord.orgCode || (session.org.code == 'OBBR' && session.DM == true && sr.interviewRecord.interviewStatus?.key in ['REMED']))){
                ...
                out.println "<span class=\"yes\">Completed</span> <a href=\"/cahubdataservices/survey/show/${sr.id}\">(View)</a>"              
            }            
    ...
    def bpvelsicrflink = { attrs, body ->
        ...
        def ir = attrs.ir
            ...
            if(!crf && session.DM == true && session.org.code == ir.orgCode){
            ...
            else if(crf && !crf.dateSubmitted && (session.DM == true && session.org.code == crf.interviewRecord.orgCode || (session.org.code == 'OBBR' && session.DM == true && crf.interviewRecord.interviewStatus?.key in ['REMED']))){
                ...
                out.println "<span class=\"yes\">Completed</span> <a href=\"/cahubdataservices/bpvElsiCrf/show/${crf.id}\">(View)</a>"             
            }  
