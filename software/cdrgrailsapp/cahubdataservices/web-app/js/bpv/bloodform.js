...
bpvErrorDict[ "bpvErr32"] = "<a href = \"#PlasmaTubes\" class=\"tabs-plasma\" title=\"Go to this question\">Please add the Conical Centrifuge tube that was derived from the plasma parent specimen</a>";
    ...
    $( "#dialog-confirm" ).dialog({
        ...
        buttons: {
            "Clear related entries": function() {
                $( this ).dialog( "close" );
                $("#" + currentSpecSelect + "PaxProcTech").val("");
                $("#" + currentSpecSelect + "PaxProcComments").val("");
                $("#" + currentSpecSelect + "PaxStorageIssues").val("");
                $("#" + currentSpecSelect + "PaxFrozen_cleardate").trigger("click");
                $("#" + currentSpecSelect + "PaxStorage_cleardate").trigger("click");
                $("#" + currentSpecSelect + "PaxProcSopDev_yes").trigger("click");
                currentSpecSelect = "";
            },
...
function plasmaCTBarcodeDel(confirm) {
   ...
   if( confirm == "confirm") {
       ...
       $("#plasmaCTBarcode").val("");
       $( "#plasmaCTVol" ).val( "0.0" );
       $(".plasmaBarcodeGroup").css("display", "none");
...
function volValid(volumeEle) {
 ...
 function showPlasmaContinue(){
     if ($.trim($('#plasmaCTBarcode').val()) == $("#origPlasmaCTBarcode").val() && $("#origPlasmaCTBarcode").val().length > 0){
       $('.plasmaBarcodeGroup').css("display", "");
 ...
 function showAddPlasmaGroup(){
     if( $.trim($('#plasmaCTBarcode').val()).length > 0 ){
         $('.edit .plasmaBarcodeGroup').css("display", "");
     } else {
         $('.show .plasma-tubes-section').css("display", "none");
         $('.edit .plasmaBarcodeGroup').css("display", "none");
     }
 }
...
function clearData (tissueType){
    ...
    $("#" + tissueId + "ProcSopDev_yes").trigger("click");
    ...
    if( tissueType.toLowerCase() === "plasma") {
        ...
        $("#plasmaHemolysis_yes").trigger("click");
...
function updateParBarCodeDisp(){
    for(var i=0; i < availableTissueTypes.length; i++){
        ...
        if($("#" + currentTissue + "ParBarcodeDisp").hasClass("readonly")){
